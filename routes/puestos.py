...
@puesto.get("/puestos/", response_model=List[schemas.puestos.Puesto], tags=["Puestos"] )
...
@puesto.post("/puesto/{ID}", response_model=schemas.puestos.Puesto, tags=["Puestos"] )
...
@puesto.put("/puesto/{ID}", response_model=schemas.puestos.Puesto, tags=["Puestos"] )
...
@puesto.delete("/puesto/{ID}", response_model=schemas.puestos.Puesto, tags=["Puestos"] )

...
@servicio_cliente.get("/servicios_clientes/", response_model=List[schemas.servicios_clientes.Servicio_Cliente], tags=["Servicios_Clientes"] )
...
@servicio_cliente.post("/servicio_cliente/{ID}", response_model=schemas.servicios_clientes.Servicio_Cliente, tags=["Servicios_Clientes"] )
...
@servicio_cliente.put("/servicio_cliente/{ID}", response_model=schemas.servicios_clientes.Servicio_Cliente, tags=["Servicios_Clientes"] )
...
@servicio_cliente.delete("/servicio_cliente/{ID}", response_model=schemas.servicios_clientes.Servicio_Cliente, tags=["Servicios_Clientes"] )
